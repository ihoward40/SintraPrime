...
- [Affidavit language](./affidavit-language.md)
- [Mode declaration sheet (v1)](./mode-declaration-sheet.v1.md)
- [Mode transition ledger (v1)](./mode-transition-ledger.v1.md)
- [Mode transparency report (template v1)](./mode-transparency-report.q1-template.v1.md)
- [How to read mode transparency report (v1)](./how-to-read-mode-transparency-report.v1.md)
